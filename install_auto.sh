...
#  update variables below with your specific dss version, user and password informtion
sudo -i <<'EOF'
...
## Uncomment if you installed hadoop integration and want to do so on the Automation Node as well
#
#echo -----------------------------
...
## Uncomment if you installed spark integration and want to do so on the Automation Node as well
...
## Uncomment if you installed MUS integration and want to do so on the Automation Node as well
